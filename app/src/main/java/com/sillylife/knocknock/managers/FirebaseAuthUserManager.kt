...
//        val appInstanceId = FirebaseInstallations.getInstance().id
...
//                                BuildConfig.APPLICATION_ID, "android", appInstanceId.toString(),
...
//            if (!TextUtils.isEmpty(fcmToken)) {
//                getAppDisposable().add(
//                        MainApplication.getInstance().getAPIService().unregisterFCM(fcmToken)
//                                .subscribeOn(Schedulers.io())
//                                .observeOn(AndroidSchedulers.mainThread())
